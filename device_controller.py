            ...
            for resource in resources:
                ...
                try:
                    ...
                    if idn:
                        ...
                        # 如果无法获取IDN，尝试根据设备地址识别
                        print(f"无法获取设备IDN，只显示地址: {resource}")
                        device_list.append(resource)
                        device_info[resource] = resource
                        
                        # 根据设备地址识别IT8811
                        if "2EC7" in resource and "8800" in resource:
                            print(f"  根据设备地址识别为IT8811设备")
                            it8811_device = resource
                        # 根据设备地址识别DMM6500
                        elif "05E6" in resource and "6500" in resource:
                            print(f"  根据设备地址识别为DMM6500设备")
                            dmm6500_device = resource
                except Exception as e:
                    # 如果无法获取IDN，只显示地址
